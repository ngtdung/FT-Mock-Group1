...
CPP_SRCS += \
../test/test_driver/gpio/test_gpio.cpp 

CPP_DEPS += \
./test/test_driver/gpio/test_gpio.d 

OBJS += \
./test/test_driver/gpio/test_gpio.o 


# Each subdirectory must supply rules for building sources it contributes
test/test_driver/gpio/%.o: ../test/test_driver/gpio/%.cpp test/test_driver/gpio/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-test-2f-test_driver-2f-gpio

clean-test-2f-test_driver-2f-gpio:
	-$(RM) ./test/test_driver/gpio/test_gpio.d ./test/test_driver/gpio/test_gpio.o

.PHONY: clean-test-2f-test_driver-2f-gpio
