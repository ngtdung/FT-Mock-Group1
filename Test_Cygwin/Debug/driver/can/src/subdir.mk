...
C_SRCS += \
../driver/can/src/FlexCAN.c 

C_DEPS += \
./driver/can/src/FlexCAN.d 

OBJS += \
./driver/can/src/FlexCAN.o 


# Each subdirectory must supply rules for building sources it contributes
driver/can/src/%.o: ../driver/can/src/%.c driver/can/src/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-driver-2f-can-2f-src

clean-driver-2f-can-2f-src:
	-$(RM) ./driver/can/src/FlexCAN.d ./driver/can/src/FlexCAN.o

.PHONY: clean-driver-2f-can-2f-src
