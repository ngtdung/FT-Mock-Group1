...
PORT_Type *g_portBase[PORT_MAX_INSTANCE];

void InitPortBase()
{
    g_portBase[0] = IP_PORTA;
    g_portBase[1] = IP_PORTB;
    g_portBase[2] = IP_PORTC;
    g_portBase[3] = IP_PORTD;
    g_portBase[4] = IP_PORTE;
}
