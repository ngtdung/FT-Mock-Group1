...
#define	MB_FLEXCAN_0	((FlexCAN_MbType*)&(IP_FLEXCAN0->RAMn[0]))
#define MB_FLEXCAN_1	((FlexCAN_MbType*)&(IP_FLEXCAN1->RAMn[0]))
#define MB_FLEXCAN_2	((FlexCAN_MbType*)&(IP_FLEXCAN2->RAMn[0]))
